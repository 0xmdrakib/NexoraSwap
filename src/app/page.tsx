    ...
    <main className="min-h-screen px-4 py-6 sm:py-10">
      <div className="mx-auto max-w-lg lg:max-w-xl">
        <div className="mb-9 flex flex-col items-center text-center">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full ring-1 ring-white/10 bg-black/20 px-4 py-1.5 text-[10px] font-medium tracking-[0.22em] uppercase text-white/70 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_10px_35px_rgba(0,0,0,0.35)]">
